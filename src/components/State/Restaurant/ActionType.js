...
export const GET_RESTAURANT_BY_USER_ID_REQUEST = "GET_RESTAURANT_BY_USER_REQUEST";
export const GET_RESTAURANT_BY_USER_ID_SUCCESS = "GET_RESTAURANT_BY_USER_SUCCESS";
export const GET_RESTAURANT_BY_USER_ID_FAILURE = "GET_RESTAURANT_BY_USER_FAILURE";
...
export const GET_RESTAURANTS_EVENTS_REQUEST = "GET_RESTAURANTS_EVENT_REQUEST";
export const GET_RESTAURANTS_EVENTS_SUCCESS = "GET_RESTAURANTS_EVENT_SUCCESS";
export const GET_RESTAURANTS_EVENTS_FAILURE = "GET_RESTAURANTS_EVENT_FAILURE";
