...
import { ADD_ITEM_TO_CART_FAILURE, ADD_ITEM_TO_CART_REQUEST, ADD_ITEM_TO_CART_REQUEST,
    ADD_ITEM_TO_CART_SUCCESS, CLEARE_CART_FAILURE, CLEARE_CART_REQUEST, CLEARE_CART_SUCCESS,
    FIND_CART_FAILURE, FIND_CART_REQUEST, FIND_CART_SUCCESS, GET_ALL_CART_ITEMS_FAILURE,
    GET_ALL_CART_ITEMS_REQUEST, GET_ALL_CART_ITEMS_SUCCESS, REMOVE_CARTITEM_FAILURE,
    REMOVE_CARTITEM_REQUEST, REMOVE_CARTITEM_SUCCESS, UPDATE_CARTITEM_FAILURE,
    UPDATE_CARTITEM_REQUEST, UPDATE_CARTITEM_SUCCESS
 } from "./ActionType";
...
export const findCart = (token) => {
    return async (dispatch) => {
        ...
        try {
            ...
            console.log("find cart data ", response)
...
export const getAllCartItems = (reqData) => {
    return async (dispatch) => {
        ...
        try {
            ...
            console.log("get all cart items data ", response)
