...
const menuItemReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case actionTypes.GET_MENU_ITEMS_BY_RESAURANT_ID_REQUEST:
        ...
        case actionTypes.GET_MENU_ITEMS_BY_RESAURANT_ID_SUCCESS:
            return {
                ...state,
                loading: false,
        ...
        case actionTypes.GET_MENU_ITEMS_BY_RESAURANT_ID_FAILURE:
