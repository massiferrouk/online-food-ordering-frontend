...
export const GET_MENU_ITEMS_BY_RESAURANT_ID_REQUEST = 'GET_MENU_ITEMS_BY_RESAURANT_ID_REQUEST'
export const GET_MENU_ITEMS_BY_RESAURANT_ID_SUCCESS = 'GET_MENU_ITEMS_BY_RESAURANT_ID_SUCCESS'
export const GET_MENU_ITEMS_BY_RESAURANT_ID_FAILURE = 'GET_MENU_ITEMS_BY_RESAURANT_ID_FAILURE'
